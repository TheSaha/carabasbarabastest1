...
<div class="modal fade" id="moreCredits" style="display: none;">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<span style="font-weight:bold;font-size:14px;margin-bottom:10px;"><a target="_blank" href="http://steamcommunity.com/groups/epicskins_official">Join our Steam Group</a> to get 100 coins.</span>
