...
<h1><span style="color:black">Balance: <span id="Coins">0</span></span></h1>
  ...
  <h3><span id="Image"><img src='http://localhost/template/img/flip/faranumar.png'></span></h3>
</center>
...
<script language="javascript" type="text/javascript" src="http://localhost/Templates/flipcs.js"></script>
