...
<table class='table table-striped dataTable no-footer'><thead><th>Game ID</th><th>User</th><th>Amount</th><th>Coin</th><th>Status</th><th>Time</th></thead><tbody>
			...
			?>
				...
				<td><? if($value['p1_pick'] == 'ct') {
					echo '<img height="25" width="25" src="http://localhost/template/img/flipcoin/ct-icon.png">';
				}else {
					echo '<img height="25" width="25" src="http://localhost/template/img/flipcoin/t-icon.png">';
				}?></td>
