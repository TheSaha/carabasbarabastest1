...
<script>
	...
	<div class="container">
		<div class="navbar-header">
			...
			<!-- <a class="navbar-brand" style="padding-top:0px;padding-bottom:0px;padding-right:0px" href="./"><img alt="PUBG-CLUB.COM" height="34" style="margin-top:8px;margin-bottom:8px;margin-right:5px" src="/template/img/just.png"></a> -->
...
<div class="list-group">
	...
	<a href="#q1" class="list-group-item">What PUBG-CLUB.COM?</a>
    ...
    <div class="col-md-9">
            <h4 id="q1" style="margin-top:0px" class="text-warning">What PUBG-CLUB.COM?</h4>
                <p>PUBG-CLUB.COM is a brand new way to gamble PUBG skins. We are NOT a jackpot site – instead players deposit skins for credits and bet those credits on a roulette inspired game:</p><p>Bet 1-7 (Grey) for X2 your credits. Bet 8-12 (Red) for X3 your credits. Bet 13-15 (Blue) for X5 your credits. Bet 0 (Gold) for X50 your credits.</p><p>It doesn't matter how big your inventory is, or how much you bet, your odds are always the same.</p><p>Bets occur in real time, across the entire site, meaning you bet, win, and lose along with other players.</p><p>All rolls are generated using a provably fair system – ensuring a fair roll each and every time.</p>
            <h4 id="q2" class="text-warning">How much are credits worth?</h4>
                <p>Credits have no real-life value. Instead they are exchanged for PUBG items from our public shop. Every 1000 credits will buy you roughly $1 worth of items. See below for more information.</p>
            <h4 id="q3" class="text-warning">How are prices determined?</h4>
                <p>Baseline prices are determined using publicly available data from Steam. Some items are not accepted due to price, volatility, or popularity. Furthermore the following discounts are applied:</p><table class="table"><tbody><tr><th>Price</th><th>You will get</th></tr><tr><td>0.00 - 0.05</td><td>Not accepted</td></tr><tr><td>0.05 +</td><td>Full price</td></tr></tbody></table><p></p>
            <h4 id="q4" class="text-warning">My items are not showing up for deposit?</h4>
                <p>First, make sure your inventory is set to public.</p><p>By default PUBG-CLUB.COM loads items from cache. Occasionally this may become out of date. To load directly from Steam (and update the cache) click the “force reload” button.</p>
            ...
            <h4 id="q9" class="text-warning">How does it work?</h4>
                <p>Each roll is computed using the SHA-256 hash of 3 distinct inputs.</p><p>First, is the server seed. This is a precomputed value generated by PUBG-CLUB.COM some time in the past. Seeds are generated in a chain such that today's seed is the hash of tomorrow's seed. Since there is no way to reverse SHA-256 we can prove each seed was generated in advance by working backwards from a precomputed chain.</p>
...
echo "Round $round_id = $roll";</pre>
                <p>Notice how any change to the lottery results radically changes the rolls.</p>
	...
	<div class="">
		...
		<ul class="list-inline" style="display:inline-block;margin-top:10px">
			<li>Copyright &copy; 2017, PUBG-CLUB.COM - All rights reserved.</li>
