		...
		<div class="panel panel-default">
			<div class="panel-body" style="margin-top: 10px;">
				...
				<ul class="nav settings-header" style="padding-top: 10px; display: inline-block;">
					<li class="dropdown">
						<img class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" src="http://localhost/template/img/lang/en.png">
						<ul class="dropdown-menu" role="menu" style="min-width: 32px;margin-left: 24%;">
							<li><a href="en.php" onclick="setLang('en')"><img src="http://localhost/template/img/lang/en.png"></a></li>
							<li><a href="ro.php" onclick="setLang('ro')"><img src="http://localhost/template/img/lang/ro.png"></a></li>
						</ul>
					</li>
				</ul>
