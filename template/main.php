...
<meta name="description" content="Best PUBG Gambling site. Open free cases every day! Join and try your luck!">
<meta http-equiv="description" content="Best PUBG Gambling site. Roulette, crash, coinflip and more. Referal system. Join and try your luck!">
<meta name="yandex-verification" content="15478672b8031537" />
		<meta charset="utf-8">
		<meta http-equiv="X-UA-Compatible" content="IE=edge">
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<title>PUBG-CLUB | Best gambling site of PUBG</title>
		...
		<script src="http://localhost/template/js/socket.io-1.4.5.js"></script>
		...
		<script src="http://localhost/template/js/twitch.js"></script>
		<script src="http://localhost/template/js/theme.js"></script>
		<script src="http://localhost/template/js/jcanvas.min.js"></script>
		<script src="http://localhost/template/js/plot.js"></script>
		<script src="https://unpkg.com/react@15/dist/react.js"></script>
		<script src="https://unpkg.com/react-dom@15/dist/react-dom.js"></script>
		<script src="http://localhost/template/js/now.js"></script>
		...
		#case {
			...
			max-width: 1050px;
			height: 69px;
			background-image: url("http://localhost/template/img/casesn.png");
...
#rgetbal:hover {
  -webkit-transform: rotate(360deg);
		...
		<script type="text/javascript" src="http://localhost/template/js/new.js?v=<?=time()?>"></script>
		<script type="text/javascript" src="http://localhost/template/js/graph.js?v=<?=time()?>"></script>
	</head>
	<body style="margin-bottom: 62px; background-attachment:fixed; background-position: 16% 0%;"  ><!--onmousemove="GoA()"-->

	<div id="papa" style="z-index:9;">
</div>
...
<div class="col-xs-3">
					...
					<div class="input-group" style="margin-bottom: 5px">
						...
						<div class="input-group-btn dropup">
							...
							<ul class="dropdown-menu smiles" style="padding: 10px;" aria-labelledby="Smiles">
    							<li>
    								<img data-smile="BibleThump" src="http://localhost/template/img/site/BibleThump.png">
    								<img data-smile="CA" src="http://localhost/template/img/site/CA.png">
    								<img data-smile="CO" src="http://localhost/template/img/site/CO.png">
    								<img data-smile="Tb" src="http://localhost/template/img/site/Tb.png">
    								<img data-smile="deIlluminati" src="http://localhost/template/img/site/deIlluminati.png">
    							</li>
    							<li>
    								<img data-smile="Fire" src="http://localhost/template/img/site/Fire.png">
    								<img data-smile="Kappa" src="http://localhost/template/img/site/Kappa.png">
    								<img data-smile="KappaPride" src="http://localhost/template/img/site/KappaPride.png">
    								<img data-smile="KappaRoss" src="http://localhost/template/img/site/KappaRoss.png">
    								<img data-smile="Keepo" src="http://localhost/template/img/site/Keepo.png">
    							</li>
    							<li>
    								<img data-smile="Kreygasm" src="http://localhost/template/img/site/Kreygasm.png">
    								<img data-smile="heart" src="http://localhost/template/img/site/heart.png">
    								<img data-smile="offFire" src="http://localhost/template/img/site/offFire.png">
    								<img data-smile="PJSalt" src="http://localhost/template/img/site/PJSalt.png">
    								<img data-smile="rip" src="http://localhost/template/img/site/rip.png">
    							</li>
    							<li>
    								<img data-smile="FailFish" src="http://localhost/template/img/site/FailFish.png">
    							</li>
							</ul>
						</div>
					</div>
					<div class="pull-left">
						<span class="userson"style="
    font-size: 20px;
    color: #ffffff;
    background: #bf1c2d;
    border-radius: 9px;
    ...
    padding: 3px;
">Users online: <span id="isonline">0</span></span>
					</div>
					<div class="pull-right">
						<!--<a href="#" data-toggle="modal" data-target="#chatRules" style="
    color: #ffffff;
    background: #bf1c2d;
    border-radius: 4px;
    box-shadow: 0px 1px 25px 1px rgb(157, 8, 8);
...
">Chat rules</a>-->
		...
		<!--<div class="panel panel-default">
			<div class="panel-body" style="margin-top: 10px;">
				<div><span class="settings-header">ROOM</span><span class="settings-header themeswitch">THEME</span></div>
				<ul class="nav settings-header" style="padding-top: 10px; display: inline-block;">
					<li class="dropdown">
						<img id="changeLang0" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" src="http://localhost/template/img/lang/en.png">
						<ul class="dropdown-menu" role="menu" style="min-width: 32px;margin-left: 24%;">
							<li><a onclick="changeLang(1)"><img src="http://localhost/template/img/lang/en.png"></a></li>
							<li><a onclick="changeLang(2)"><img src="http://localhost/template/img/lang/br.png"></a></li>
							<li><a onclick="changeLang(3)"><img src="http://localhost/template/img/lang/ru.png"></a></li>
						</ul>
					</li>
					<a  style=" position:absolute; margin-top:-8%; margin-left:32%;" href="/?template=light" class=""><div class="template" style=" background-color: #272727;">DARK</div></a>
				</ul>
		...
		<div class="panel panel-default settings-block">
				<div class="panel-body" style="margin-top: 10px;">
					...
					</ul><a href="/?template=light" class="settings-header style-settings"><div class="template" style="background-color: #272727;">DARK</div></a></div>
			</div>
		<!--<div class="panel panel-default">
		...
		<ul class="nav nav-pills nav-justified chooseBar" style="margin-top:25px;color: #ffffff;background: #bf1c2d;border-radius: 9px;margin: 3px;box-shadow: 0px 1px 25px 1px rgb(157, 8, 8);">
			<li id="roulette-nav" class="active" style="cursor: pointer;"><a onclick="changeGame('roulette')"><i id="placer2" class="fa fa-dot-circle-o" aria-hidden="true"></i> Roulette </a></li>
...
<div id="roulette">
		...
		<div id="case" style="margin-bottom: 5px; background-position: -1042.5px 0px;"><div id="left-shadow" style="
    position: absolute;
    left: -1px;
    top: 0px;
    bottom: -1px;
    width: 30%;
    z-index: 2;
    background: linear-gradient(to right, #161619 0%, rgba(0, 0, 0, 0) 100%);
"></div><div id="right-shadow" style="position: absolute;right: -1px;top: 0px;bottom: -1px;width: 30%;z-index: 2;background: linear-gradient(to right, rgba(0, 0, 0, 0) 0%, #151517 100%);"></div><div id="pointer"></div></div>
		<div class="well text-center" style="padding:5px;margin-bottom:5px"><div id="past"></div>
			...
			<center>
				...
				<h3 style="border-radius: 10px;text-align: center;color: #fff;padding: 5px;" class="ball-1 text-center">To play you need to <a href="http://localhost//login">login with Steam</a>!</h3>
			</center>
			<?php }else{ ?>
    ...
    background: #bf1c2d;
    padding: 8px;
    border-radius: 10px;">Balance: <span id="dongers"></span> <span id="balance">0</span> <i style="cursor:pointer" class="fa fa-refresh noselect" id="rgetbal"></i></span>
					</p>
					<div class="form-group">
						<div class="btn-group">
                    ...
                    <input type="text" class="form-control input-lg" placeholder="0" id="betAmount" style="background: black;
    box-shadow: 0px 1px 25px 1px rgb(157, 8, 8);">
				</div>
			</div>
			<?php } ?>
...
<div class="form-group">
    ...
    background: #bf1c2d;
    padding: 8px;
    border-radius: 10px;">Balance: <span id="dongers"></span> <span id="mbalance">0</span> <i style="cursor:pointer" class="fa fa-refresh noselect" id="mgetbal"></i></span>
				</p>
				<div class="form-group">
					<div class="btn-group">
				...
				<input type="text" class="form-control input-lg" placeholder="0" id="mbetAmount" style="margin-top:15px;box-shadow: 0px 1px 25px 1px rgb(157, 8, 8);">
			</div>
		</div>
<?php } ?>
	<br>
...
<div class="form-group">
    ...
    background: #bf1c2d;
    padding: 8px;
    border-radius: 10px;">Balance: <span id="dongers"></span> <span id="dbalance">0</span> <i style="cursor:pointer" class="fa fa-refresh noselect" id="dgetbal"></i></span>
				</p>
				<div class="form-group">
					<div class="btn-group">
...
<span style="font-size: 20px;
    ...
    background: #bf1c2d;
    padding: 8px;
    border-radius: 10px;">Balance: <span id="dongers"></span> <span id="jbalance">0</span> <i style="cursor:pointer" class="fa fa-refresh noselect" id="jgetbal"></i></span>
</p>
...
<div class="alert alert-info text-center" style=margin-top:10px;margin-right:25px;margin-left:25px>
    ...
    <style>
        #casebox01 {
            ...
            margin:0px auto;
            border-radius:10px;
            background-image: url("http://localhost/template/img/mcases.png");
         }
        #pointercase{
            width:3px;
            background:#c3c3c3;
            ...
            <div class="row">
                ...
                <div class="col-sm-3" id="box01" style="margin-bottom:35px;">
                    <div class="well text-center" style="width:90%;margin-bottom:0;padding: 10px;border-radius:7px 7px 0 0;cursor:pointer;">
                        ...
                        <img style="width:75%;" src="http://localhost/template/img/box03.png">
                    </div>
...
<div id="mbox" class="hidden" style="margin-top:100;">
	...
	<style>
        #casebox01 {
            ...
            margin:0px auto;
            border-radius:10px;
            background-image: url("http://localhost/template/img/casesb1.png");
       }
        #casebox02 {
            ...
            margin:0px auto;
            border-radius:10px;
            background-image: url("http://localhost/template/img/casesb02.png");
        ...
        #casebox03 {
            ...
            margin:0px auto;
            border-radius:10px;
            background-image: url("http://localhost/template/img/casesb03.png");
        ...
        #casebox04 {
            ...
            margin:0px auto;
            border-radius:10px;
            background-image: url("http://localhost/template/img/casesb04.png");
			...
			<div class="row">
				...
				<div class="col-xs-9 hidden" id="contentbox01" style="margin-bottom:35px;">
					...
					<div class="form-group">
						...
						<br><br><h4><div id="nototo" class="fa fa-info"></div></h4>
					</div>
					<?php } ?>
				...
				<div class="col-xs-9 hidden" id="contentbox02" style="margin-bottom:35px;">
					...
					<div class="form-group">
						...
						<br><br><h4><div id="" class="fa fa-info"> You must have at least 1 coin on your balance.</div></h4>
					</div>
					<?php } ?>
				...
				<center><div class="col-sm-3" id="box01" style="margin-bottom:35px;">
					<div class="well text-center" style="width:90%;margin-bottom:0;padding: 10px;border-radius:7px 7px 0 0;cursor:pointer;">
						<div id="kdown" style="border-radius: 10px;text-align: center;position: absolute;color: #fff;padding: 5px;" class="ball-0 text-center"></div>
						<img style="width:75%;" class="bbox" src="http://localhost/template/img/boxes/box001.png">
					</div>
				...
				<center><div class="col-sm-3" id="box02" style="margin-bottom:35px;">
					<div class="well text-center" style="width:90%;margin-bottom:0;padding: 10px;border-radius:7px 7px 0 0;cursor:pointer;">
						<div id="kdown2" style="border-radius: 10px;text-align: center;position: absolute;color: #fff;padding: 5px;" class="ball-0 text-center"></div>
						<img style="width:75%;" class="bbox" src="http://localhost/template/img/boxes/box002.png">
					</div>
					<div class="well text-center casename" style="width:90%;padding: 10px;border-radius:0 0 7px 7px;cursor:pointer;">
						<b>Box 02</b>
					</div>
				...
				<center><div class="col-sm-3" id="box03" style="margin-bottom:35px;">
					<div class="well text-center" style="width:90%;margin-bottom:0;padding: 10px;border-radius:7px 7px 0 0;cursor:pointer;">
						...
						<img style="width:75%;" class="bbox" src="http://localhost/template/img/boxes/box003.png">
					</div>
					<div class="well text-center casename" style="width:90%;padding: 10px;border-radius:0 0 7px 7px;cursor:pointer;">
						<b>Box 03</b>
					</div>
				...
				<center><div class="col-sm-3" id="box04" style="margin-bottom:35px;">
					<div class="well text-center" style="width:90%;margin-bottom:0;padding: 10px;border-radius:7px 7px 0 0;cursor:pointer;">
						...
						<img style="width:75%;" class="bbox" src="http://localhost/template/img/boxes/box004.png">
					</div>
					<div class="well text-center casename" style="width:90%;padding: 10px;border-radius:0 0 7px 7px;cursor:pointer;">
						<b>Box 04</b>
					</div>
...
#coin .front {
    ...
    border-radius: 50%;
    background-image: url('http://localhost/template/img/flipcoin/ct-icon.png');
...
#coin .back {
	...
	border-radius: 50%;
	background-image: url('http://localhost/template/img/flipcoin/t-icon.png');
	background-size: cover;
	display: block;
}
...
<div id="defaultPCF">
    ...
    background: #bf1c2d;
    padding: 8px;
    border-radius: 10px;">Balance: <span id="dongers"></span> <span id="cfbalance">0</span> <i style="cursor:pointer" class="fa fa-refresh noselect" id="cfgetbal"></i></span>
	</p>

			<input type="text" class="form-control input-lg" placeholder="0" id="cfbetAmount" style="margin-top:15px;box-shadow: 0px 1px 25px 1px rgb(157, 8, 8);">
		<br>
			<img height="100" width="100" src="http://localhost/template/img/flipcoin/ct-icon.png" id="cfSelectCT" style="border-radius: 50%"/>
			<img height="100" width="100" src="http://localhost/template/img/flipcoin/t-icon.png" id="cfSelectT" style="border-radius: 50%"/>
			<br>
			<br>
		...
		<div id="PanelCoinflip" class="hidden">
			<div class="panel text-center" style="margin-bottom:10px;margin-top:25px; padding: 20px; height:315px;">
				...
				<div class="well text-center pull-left jucator" style="margin-bottom:10px;margin-top:50px; padding: 20px;border-top-left-radius:0;border-bottom-left-radius:0;width:25%;">
					<img id="P1avatar" class="rounded" >
					<span id="P1name"style="
    color: black;
">None</span>
				</div>
				<div class="well text-center pull-left jucator2" style="margin-bottom:10px;margin-top:50px; padding: 20px;border-top-left-radius:0;border-bottom-left-radius:0;">
					<img id="P1choice" class="rounded pull-right" style="width:32px;" >
				</div>
				...
				<div class="well text-center pull-right jucator" style="margin-bottom:10px;margin-top:50px; padding: 20px;border-top-left-radius:0;border-bottom-left-radius:0;width:25%;">
					<img id="P2avatar" class="rounded" >
					<span id="P2name"style="
    color: black;
">None</span>
				</div>
				<div class="well text-center pull-right jucator2" style="margin-bottom:10px;margin-top:50px; padding: 20px;border-top-right-radius:0;border-bottom-right-radius:0;">
					<img id="P2choice" class="rounded pull-left" style="width:32px;" >
				</div>
...
<div id="crash" class="hidden" style="margin-top:25px;">
	<div id="mainpage" class="col-xs-9">
		<br>
<div id="bet" style="margin-left: 590px;margin-bottom: -20px;"><span style="
  ">bet:</span></div>
		<center>
				...
				<canvas id="crash-graph" width="547" height="331" style="width: 608px; height: 368px;margin-left: -780px;"></canvas>
				<script>
				        var graph = new Graph();
    ...
    background: #bf1c2d;
    padding: 8px;
    border-radius: 10px;">Balance: <span id="dongers"></span> <span id="crbalance">0</span> <i style="cursor:pointer" class="fa fa-refresh noselect" id="crgetbal"></i></span>
					</p>
					 
					<input type="text" style="width: calc(50% - 50px);margin-top: -290px;width: 230px;padding: 25;box-shadow: 0px 1px 25px 1px rgb(157, 8, 8);" class="form-control input-lg" placeholder="0" id="crbetSum">Auto cashout:<input type="text" style="width: calc(50% - 50px);margin-bottom: 40px;width: 230px;padding: 25;box-shadow: 0px 1px 25px 1px rgb(157, 8, 8);" class="form-control input-lg" placeholder="100.00" id="crAutoWithdraw">
					<input id="joinCrash" class="btn btn-primary btn-lg joinCrash" value="Place Bet" data-todo='joinCrash' style="font-weight: bold; margin-bottom:3px;    padding: 20px;
    margin-bottom: 40px;" readonly />
			...
			<div id="crHist" class="margin-top:15px;container; pull-right"style="
    margin-top: -200px;
    width: 30%;
"></div>
...
<div id="safebox" class="hidden" style="margin-top:25px;">
    ...
    background: #bf1c2d;
    padding: 8px;
    border-radius: 10px;">Balance: <span id="dongers"></span> <span id="sbbalance">0</span> <i style="cursor:pointer" class="fa fa-refresh noselect" id="sbgetbal"></i></span>
					</p>
